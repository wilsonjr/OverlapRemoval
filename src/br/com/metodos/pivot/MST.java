...
import br.com.metodos.pivot.MST.Kruskal.EDGE;
...
public class MST {
    ...
    private ArrayList<Retangulo> C;
    private int[] vertices;
    
    public void selectPivots(ArrayList<Retangulo> conjunto, int qtdPagina) {
        this.C = conjunto;
        ...
        ArrayList<Retangulo> representativos = new ArrayList<>();
        ArrayList<ArrayList<Retangulo>> grupos = new ArrayList<>();
        
        C.get(0).setPivot(true);
        C.get(0).setCluster(0);
        
        representativos.add(C.get(0));
        grupos.add(new ArrayList<Retangulo>());
        ...
        for( ArrayList<Retangulo> r: grupos )
            System.out.println("size: "+r.size());
        
        System.out.println("Quantidade de representativos: "+count);
    }

    private int[] findNearest(ArrayList<Retangulo> representativos, Retangulo r) {
        int idx = -1;
    ...
    private void promoteRepresentative(ArrayList<Retangulo> representativos, ArrayList<ArrayList<Retangulo>> grupos, int idx, int idx2) {
    ...
    private void selectRepresentive(int[] components, ArrayList<Retangulo> representativos, 
                                    ArrayList<ArrayList<Retangulo>> grupos, int key) {
