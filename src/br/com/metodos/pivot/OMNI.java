...
public class OMNI {    
    ...
    public void selectPivots(ArrayList<Retangulo> conjunto, int cardinalidade) {
        if( conjunto.size() < 2 ) 
    ...
    private void findOtherPivots(int f1, int f2, ArrayList<Retangulo> conjunto, int cardinalidade, double edge) {
